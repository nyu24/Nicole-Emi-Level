...
label start:
    ...
    s "Alastor Brahe suddenly collasped and lost consciousness in his home during a party. He was brought to the hospital and had his blood drawn and urine tested."
    s "He suddenly went into respiratory depression and lost consciousness once more. Doctors were not able to revive him."
    s "Based on the hospital report, the deceased had high levels of Fentanyl in his blood, and low levels of THC. Their urine had a low pH with Fentanyl and THC detected."
    s "The deceased was also prescibed Fentanyl for their severe chronic pain."
    s "The medical opinion is that Alastor died from overdosing on his Fentanyl medication"
    s "The parents' testimony states Alastor was compliant with his prescription and had no history of mental illness that would suggest a suicide attempt."
    s "From the friends' testimony, Alastor didn't drink any alcohol at the party. And instead drank fruit juice."
