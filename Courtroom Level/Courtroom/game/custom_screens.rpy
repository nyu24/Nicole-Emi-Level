...
screen case_description:
    ...
    $ item_name = "Case A"
    $ item_desc = "Alastor Brahe collasped and lost conciousness in his home during a party. The party was casual with alcohol and marijuana brownies. According to the hospital report and lab results from the hospital Alastor died from overdosing on his Fentanyl prescription, but his parents argue he couldn't have as they were keeping track of his intake."
